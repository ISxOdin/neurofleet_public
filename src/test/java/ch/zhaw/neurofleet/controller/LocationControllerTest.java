...
public class LocationControllerTest {
    ...
    void setup() {
        ...
        when(locationRepository.findAll(PageRequest.of(0, 20))).thenReturn(new PageImpl<>(List.of(baseLocation)));
    ...
    @Test
    @Order(1)
    public void testCreateLocation_AdminRole() throws Exception {
    ...
    @Test
    @Order(2)
    public void testCreateLocation_OwnerRole() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(true);
    ...
    @Test
    @Order(3)
    public void testCreateLocation_FleetManagerRole() throws Exception {
        LocationCreateDTO dto = new LocationCreateDTO();
        dto.setName(TEST_NAME);
        dto.setAddress(TEST_ADDRESS);
        dto.setCompanyId(COMPANY_ID);
    ...
    @Test
    @Order(4)
    public void testGetAllLocations_AdminRole() throws Exception {
    ...
    @Test
    @Order(5)
    public void testGetAllLocations_OwnerRole() throws Exception {
    ...
    @Test
    @Order(6)
    public void testGetAllLocations_FleetmanagerRole() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(false);
        when(userService.userHasAnyRole("fleetmanager")).thenReturn(true);

        PageImpl<Location> page = new PageImpl<>(List.of(baseLocation));
        when(locationRepository.findAllByFleetmanagerId(FLEETMANAGER_ID, PageRequest.of(0, 20))).thenReturn(page);
    ...
    @Test
    @Order(7)
    public void testGetAllLocations_UnauthorizedRole() throws Exception {
    ...
    @Test
    @Order(8)
    public void testGetLocationById_AdminRole() throws Exception {
        when(userService.userHasAnyRole("admin")).thenReturn(true);
    ...
    @Test
    @Order(9)
    public void testGetLocationById_OwnerWithAccess() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(true);
        when(userService.userHasAnyRole("owner")).thenReturn(true);
        when(locationRepository.existsByIdAndCompanyId(LOCATION_ID, COMPANY_ID)).thenReturn(true);
    ...
    @Test
    @Order(10)
    public void testGetLocationById_OwnerWithWrongCompany() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(true);
        when(userService.userHasAnyRole("owner")).thenReturn(true);
    ...
    @Test
    @Order(11)
    public void testGetLocationById_NotFound() throws Exception {
        when(userService.userHasAnyRole("admin")).thenReturn(true);
        when(userService.userHasAnyRole("owner")).thenReturn(false);
    ...
    @Test
    @Order(12)
    public void testUpdateLocation_AdminRole() throws Exception {
        LocationCreateDTO dto = new LocationCreateDTO();
    ...
    @Test
    @Order(13)
    public void testUpdateLocation_OwnerWithAccess() throws Exception {
        LocationCreateDTO dto = new LocationCreateDTO();
        dto.setName(UPDATED_TEST_NAME);
        dto.setAddress(UPDATED_TEST_ADDRESS);
    ...
    @Test
    @Order(14)
    public void testUpdateLocation_OwnerWithoutAccess() throws Exception {
        LocationCreateDTO dto = new LocationCreateDTO();
    ...
    @Test
    @Order(15)
    public void testUpdateLocation_UnauthorizedRole() throws Exception {
        LocationCreateDTO dto = new LocationCreateDTO();
        dto.setName("Blocked");
        dto.setAddress(UPDATED_TEST_ADDRESS);
        dto.setCompanyId(COMPANY_ID);
    ...
    @Test
    @Order(17)
    public void testDeleteLocation_AdminRole() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(true);
        when(userService.userHasAnyRole("owner")).thenReturn(false);
    ...
    @Test
    @Order(18)
    public void testDeleteLocation_OwnerWithAccess() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(true);
        when(userService.userHasAnyRole("owner")).thenReturn(true);
        when(locationRepository.existsByIdAndCompanyId(LOCATION_ID, COMPANY_ID)).thenReturn(true);
    ...
    @Test
    @Order(19)
    public void testDeleteLocation_OwnerWithoutAccess() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(true);
        when(userService.userHasAnyRole("owner")).thenReturn(true);
        when(locationRepository.existsByIdAndCompanyId(LOCATION_ID, COMPANY_ID)).thenReturn(false);
    ...
    @Test
    @Order(20)
    public void testDeleteLocation_UnauthorizedRole() throws Exception {
        when(userService.userHasAnyRole("admin", "owner")).thenReturn(false);
