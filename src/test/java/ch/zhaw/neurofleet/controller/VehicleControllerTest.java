...
public class VehicleControllerTest {
    ...
    @Test
    @Order(1)
    public void testCreateVehicle_AdminRole() throws Exception {
    ...
    @Test
    @Order(2)
    public void testGetVehicles_AdminRole() throws Exception {
    ...
    @Test
    @Order(3)
    public void testCreateVehicle_OwnerRole() throws Exception {
        VehicleCreateDTO dto = new VehicleCreateDTO();
    ...
    @Test
    @Order(4)
    public void testCreateVehicle_FleetmanagerRole() throws Exception {
        VehicleCreateDTO dto = new VehicleCreateDTO();
    ...
    @Test
    @Order(5)
    public void testGetVehicles_OwnerRole() throws Exception {
    ...
    @Test
    @Order(6)
    public void testGetVehicles_FleetmanagerRole() throws Exception {
        when(userService.userHasAnyRole("admin")).thenReturn(false);
    ...
    @Test
    @Order(7)
    public void testGetVehicles_UnauthorizedRole() throws Exception {
        when(userService.userHasAnyRole("admin")).thenReturn(false);
        when(userService.userHasAnyRole("owner")).thenReturn(false);
    ...
    @Test
    @Order(8)
    public void testGetVehicleById_AdminRole() throws Exception {
        when(userService.userHasAnyRole("owner")).thenReturn(false);
        when(userService.userHasAnyRole("fleetmanager")).thenReturn(false);
    ...
    @Test
    @Order(9)
    public void testGetVehicleById_OwnerWithAccess() throws Exception {
        when(userService.userHasAnyRole("owner")).thenReturn(true);
        when(userService.getCompanyIdOfCurrentUser()).thenReturn(COMPANY_ID);
    ...
    @Test
    @Order(10)
    public void testGetVehicleById_OwnerWithoutAccess() throws Exception {
        when(userService.userHasAnyRole("owner")).thenReturn(true);
    ...
    @Test
    @Order(11)
    public void testGetVehicleById_FleetmanagerWithoutAccess() throws Exception {
        when(userService.userHasAnyRole("fleetmanager")).thenReturn(true);
    ...
    @Test
    @Order(13)
    public void testUpdateVehicle_AdminRole() throws Exception {
        VehicleCreateDTO dto = new VehicleCreateDTO();
        ...
        Vehicle updated = new Vehicle(dto.getLicensePlate(), dto.getVin(), dto.getLocationId(), dto.getCompanyId());
    ...
    @Test
    @Order(14)
    public void testUpdateVehicle_UnauthorizedRole() throws Exception {
        VehicleCreateDTO dto = new VehicleCreateDTO();
    ...
    @Test
    @Order(16)
    public void testUpdateVehicle_SecurityException() throws Exception {
        VehicleCreateDTO dto = new VehicleCreateDTO();
    ...
    @Test
    @Order(17)
    public void testDeleteVehicle_AdminRole() throws Exception {
        when(userService.userHasAnyRole("admin", "owner", "fleetmanager")).thenReturn(true);
        when(vehicleRepository.existsById(VEHICLE_ID)).thenReturn(true);
    ...
    @Test
    @Order(19)
    public void testDeleteVehicle_UnauthorizedRole() throws Exception {
        when(userService.userHasAnyRole("admin", "owner", "fleetmanager")).thenReturn(false);
    ...
    @Test
    @Order(20)
    public void testGetVehicleTypes_AlwaysAllowed() throws Exception {
